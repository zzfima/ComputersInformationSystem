...
public class MQVersionGatherConsumer
{
    ...
    public void Initialize(Configuration configuration)
    {
        ...
        _phoenixVersionRetriever = new VersionRetriver(_configuration.InstalledVersions.Where(n => n.Name == "APP1").FirstOrDefault().Path);
        _firmwareVersionRetriever = new VersionRetriver(_configuration.InstalledVersions.Where(n => n.Name == "APP2").FirstOrDefault().Path);
